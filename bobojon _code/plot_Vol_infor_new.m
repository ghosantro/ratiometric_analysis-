...
= plot_Vol_infor_new(APD_infor_cell, Area_AP_cell,...
...
fibrillation_index,save_figure_index,fname,file_name_start_index,file_name_end_index,known_pacing,pacing_frequency,frameperiod)
...
if save_figure_index ==0 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'signal_swing',  '.fig'));
    close all
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'num_AP',  '.fig'));
    close all
...
filtered_upstroke_matrix = filter_upstroke_onset (upstroke_cell, number_AP_matrix, known_pacing, pacing_frequency, save_figure_index,fname, file_name_start_index,file_name_end_index,fibrillation_index,signal_swing_matrix,frameperiod); 
...
if save_figure_index==0
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'APD80_even',  '.fig'));
    close all;
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'APD50_odd',  '.fig'));
    close all; 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'APD80_odd',  '.fig'));
    close all; 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'APD50_even',  '.fig'));
    close all; 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'area_ratio_odd',  '.fig'));
    close all
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'area_ratio_even',  '.fig'));
    close all
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'onset_upstroke',  '.fig'));
    close all; 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'AP_skewness_even',  '.fig'));
    close all; 
    ...
    hgsave(gcf,strcat('F:\data analysis result\20110705\matlab_figure_from_autanalysis\', fname(file_name_start_index:file_name_end_index),'AP_skewness_odd',  '.fig'));
    close all;
end  
